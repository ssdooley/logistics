...
var InventoryComponent = /** @class */ (function () {
    function InventoryComponent(service, attachmentService, snacker) {
        this.service = service;
        this.attachmentService = attachmentService;
        this.snacker = snacker;
        this.uploading = false;
    }
    InventoryComponent.prototype.exportToExcel = function () {
    ...
    InventoryComponent.prototype.fileChange = function (files) {
    ...
    InventoryComponent.prototype.clearFiles = function () {
        this.service.clearUploads();
    };
    __decorate([
        core_1.ViewChild('fileInput')
    ], InventoryComponent.prototype, "fileInput", void 0);
