...
namespace Identity.Mock
{
    public class MockProvider : IUserProvider
    {
        ...
        public Task Create(HttpContext context) => throw new NotImplementedException("Use Create(string samAccountName) for MockProvider");
        ...
        public static IQueryable<ADUser> ADUsers = new List<ADUser>()
        {
            new ADUser
            {
